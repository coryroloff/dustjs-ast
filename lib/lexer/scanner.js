export default class Scanner {
	constructor (code, options = {indexOffset: 0, lineNumberOffset: 0, lineStartOffset: 0}) {
		const indexOffset = (options.indexOffset > 0 ? options.indexOffset - 1 : 0);
		const lineNumberOffset = (options.lineNumberOffset > 0 ? options.lineNumberOffset - 1 : 0);
		const lineStartOffset = (options.lineStartOffset > 0 ? options.lineStartOffset - 1 : 0);
